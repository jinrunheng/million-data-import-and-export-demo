...
public class OssService {
    ...
    public String uploadFile(String fileName, String filePath) {
        ...
        String objectName = "exampledir/" + fileName + System.currentTimeMillis() + ".xlsx";
        // 返回 Excel 下载路径
        String returnPath = "https://dooby-excel-bucket.oss-cn-shenzhen.aliyuncs.com/" + objectName;
